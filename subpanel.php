                           ...
                           <!--<a href="service.html" class="nav-item nav-link">Service</a>--> 
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="suboffdrivinglic.php" class="dropdown-item">Driving License</a>
                                    <a href="suboffduplic.php" class="dropdown-item">Duplicate License</a>
                                    <a href="subofflearners.php" class="dropdown-item">Learners License</a>
                                    <a href="suboffownership.php" class="dropdown-item">Ownership Transfer</a>
                                    <a href="suboffrenewal.php" class="dropdown-item">Renewal License</a>
                                    <a href="suboffvreg.php" class="dropdown-item">Vehicle Registration</a>
                                </div>
                            </div>
