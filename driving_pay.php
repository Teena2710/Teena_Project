...
if(isset($_POST['register']))
{
  ...
  $sql=mysqli_query($con,"INSERT INTO `tbl_drivinglicense` (`reg_id`, `first_name`, `last_name`, `age`, `gender`, `parent_name`, `house_name`, `state`,`district`, `email`, `phone_no`, `license_type`, `date_of_issue`, `expiriry_date`, `blood`,`image`,`aadhar`,`sslc`,`is_approved`) VALUES 
  ('$regid', '$fname', '$lname', '$age', '$gender','$pname', '$house_name', '$state','$district', '$email', '$phone', '$license_type', '$isdate', '$exdate', '$blood','$iname','$aname','$sname','NO')") or die(mysqli_error($con));
  if($sql)
...
<form action="payaction.php?id=<?php echo $regid;?>" method="post" style="margin-top:50px;" align="center">
<script
