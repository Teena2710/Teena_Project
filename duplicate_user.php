...
$result=mysqli_query($con,"SELECT dup_id,driving_id,first_name,last_name,age,gender,image,parent_name,house_name,state,district,email,phone_no,license_type,date_of_issue,expiriy_date,blood FROM `tbl_duplicatelicense` where driving_id=$feg") or die(mysqli_error($con));
...
$pdf -> Line(10, 198, 190,198);
$pdf->Image("digital.jpg", 90, 200, 50);
$pdf->Image("qr_code.png", 30, 200, 30);
$pdf->Ln(); 
$pdf->Ln(); 
