...
if(isset($_SESSION['learners_id']))
    $learners_id=$_SESSION['learners_id'];
$res=mysqli_query($con,"select * from tbl_learners_reg where learners_id=$learners_id");
...
if(isset($_POST['update']))
{
    ...
    $ql= mysqli_query($con,"UPDATE tbl_learners_reg SET `aadhar`='$aname' where learners_id=$learners_id")
...
if(isset($_POST['img_update']))
{
    ...
    $sql= mysqli_query($con,"UPDATE tbl_learners_reg SET `image`='$iname' where learners_id=$learners_id")
    or die(mysqli_error($con));
    if($sql)
    {
...
if(isset($_POST['sslc_update']))
{
    ...
    $sql= mysqli_query($con,"UPDATE tbl_learners_reg SET `sslc`='$sname' where learners_id=$learners_id")
    or die(mysqli_error($con));
    if($sql)
    {
...
<html lang="en">
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <button  class="nav-item nav-link active"><a href="learners_app.php">Home</a></button>
    ...
    <h3>Image</h3>
        ...
        <div class="input-box" align="center" style="margin-left:50px;">
            ...
            <input type="text" name="file" value="<?php echo $row['image']; ?>" maxlength="50" required="">
    ...
    outline: none;">
        <h3>Aadhar</h3>
        <embed width=250 height=350  src='uploads/<?php echo $row['aadhar']?>'/><br><br>
        <div class="input-box" align="center" style="margin-left:50px;">
    ...
    outline: none;">
        <h3>SSLC</h3>
        <embed width=750 height=500 src='uploads/<?php echo $row['sslc']?>'/><br>
        <div class="input-box" align="center" style="margin-left:50px;">
