...
if(isset($_POST['submit']))
{
  ...
  $sql=mysqli_query($con,"insert into tbl_register(fname,lname,gender,email,house_name, state,district,phone_no,username,password,repassword)values('$fname','$lname','$gender','$email','$house_name', '$state','$district','$phone','$username',md5('$pass'),md5('$pass'))");
if($sql)
echo "<script>alert('Registered  successfully');</script>";
  $last_id=mysqli_insert_id($con);
mysqli_query($con,"insert into tbl_login values($last_id, '$username',md5('$pass'),'user','1')") or die(mysqli_error($con));
...
<body>
        ...
        <div class="user_reg">
    <div class="title"><b>User Registration<b></div>
    <br/> <br/> <br/>
    <div>
    ...
    <form  method="post" enctype="multipart/form-data"  action="#" onsubmit="return validation(this);">
        <div class="user-details">
          ...
          <select style="height:45px;width:430px;" id="gender">
      ...
      function ValidEmail() 
        ...
        <select name="state" id="state" name="state" style="height:45px;width:430px;" required>
          ...
          <div class="input-box">
            ...
            <select name="district" name="district" id="district" style="height:45px;width:430px;" required>
            <option value="Select">Select</option>
...
var pas2=document.getElementById("repass");
	...
	return true;
                ...
                <input type="submit" name="submit" id="submit" value="Register" style="width: 80%;
    margin-left: 35px;
    height: 50px;
    border: 1px solid;
    background: #2691d9;
    ...
    outline: none;"><br>
                  ...
                  <div>   Already have a account?<a href="login.php" style=" color: blue;">Login</a></div>

                     <A href="index.html"><input  name="back"  value="Back" style="width: 80%;
    margin-left: 35px;
    height: 50px;
    text-align:center;
    border: 1px solid;
