...
if(isset($_POST['submit']))
{
 ...
 $house_name=$_POST['house_name'];
  ...
  mysqli_query($con,"insert into tbl_register(ownership_fname,ownership_lname,institution_name,i_district,gender,email,house_name,state,district,phone_no,username,password,repassword)values
  ('$ofname','$olname','$iname','$i_district','$gender','$email','$house_name', '$state','$district','$phone','$username',md5('$pass'),md5('$pass'))");
$last_id=mysqli_insert_id($con);
mysqli_query($con,"insert into tbl_login values($last_id, '$username',md5('$pass'),'institution',3)") or die(mysqli_error($con));
...
<head>
    <meta charset="utf-8">
    <title>RTO - Institution Registeration</title>
...
<div class="inst_reg">
    ...
    <form  method="post" enctype="multipart/form-data"  action="#" onsubmit="return validation(this);">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Ownership  First Name</span>
            <input type="text" name="ofname" value=""  id="ofname" required autofocus autocomplete = "off" required onchange ="ValidName();">
            <span id="msg1" style="color:red;"></span>
                        <script>        
                            function ValidName() 
                            {
                                var val = document.getElementById('ofname').value;
          ...
          <div class="input-box">
            <span class="details">Ownership  Last Name</span>
            <input type="text" name="olname" value=""  id="olname" required autofocus autocomplete = "off" required onchange ="ValidName();">
            <span id="msg11" style="color:red;"></span>
                        <script>        
                            function ValidName() 
                            {
                                var val = document.getElementById('olname').value;

                                if (!val.match(/^[A-Z][A-Za-z\ ]{0,}$/)) 
                                {
                                    document.getElementById('msg11').innerHTML="Start with a Capital letter & Only alphabets without space are allowed!!";
          ...
          <div class="input-box">
            ...
            <input type="text" name="iname" value=""  id="iname" required autofocus autocomplete = "off" required onchange ="Validlname();"> 
          ...
          <div class="input-box">
            <span class="details">Institution District</span>
            <select name="i_district"style="height:45px;width:430px;" required>
