...
if(isset($_POST['verifyemail']))
{
  ...
  if($count>0)
  {
    ...
    if($result)
    {
      mysqli_query($con,"insert into tbl_ownership(reg_id,email)values('$regid','$user')");

      echo "<script>alert('Mail Send Successfully');window.location.href='ownership_2.php';</script>";     
    }
    else
    {
