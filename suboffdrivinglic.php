...
$sql=mysqli_query($con,"SELECT * FROM `tbl_drivinglicense` where is_approved='NO' order by driving_id ASC") or die(mysqli_error($con));
if(isset($_POST['approve']))
{
    $driving_id=$_POST['driving_id'];
    mysqli_query($con,"UPDATE `tbl_drivinglicense` SET `is_approved` = 'YES' WHERE `tbl_drivinglicense`.`driving_id` = $driving_id;") or die(mysqli_error($con));
    echo "<script>alert('Approved successfully');window.location.href='suboffdrivinglic.php';</script>";
}
...
if(isset($_POST['viewdetails']))
{
    $driving_id=$_POST['driving_id'];
    $_SESSION['driving_id']=$driving_id;
    header('location:suboffdrivinglic_pdfviewdetails.php');
}
...
<html lang="en">
    ...
    <body>
        ...
        <!-- Nav Bar End -->
    <h1 align="center">Driving License List</h1>
                ...
                ?>
                    <tr>
                        ...
                        <td width=300><form method="post">
                            <input type="hidden" name="driving_id" value="<?php echo $res['driving_id'];?>">
