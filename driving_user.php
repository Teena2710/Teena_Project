...
$result=mysqli_query($con,"SELECT driving_id,first_name,last_name,age,gender,parent_name,house_name,state,district,email,phone_no,license_type,date_of_issue,expiriry_date,blood FROM `tbl_drivinglicense` where reg_id=$feg ") or die(mysqli_error($con));
...
$pdf->Image("digital.jpg", 90, 200, 80);
