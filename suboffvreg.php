...
$sql=mysqli_query($con,"SELECT * FROM `tbl_vreg` where is_approved='NO' order by vreg_id ASC") or die(mysqli_error($con));
if(isset($_POST['approve']))
{
    $vreg_id=$_POST['vreg_id'];
    mysqli_query($con,"UPDATE `tbl_vreg` SET `is_approved` = 'YES' WHERE `tbl_vreg`.`vreg_id` = $vreg_id;") or die(mysqli_error($con));
