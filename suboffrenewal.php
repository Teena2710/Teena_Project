...
$sql=mysqli_query($con,"SELECT * FROM `tbl_renewal` where is_approved='NO' order by renewal_id ASC") or die(mysqli_error($con));
if(isset($_POST['approve']))
{
    $renewal_id=$_POST['renewal_id'];
    mysqli_query($con,"UPDATE `tbl_renewal` SET `is_approved` = 'YES' WHERE `tbl_renewal`.`renewal_id` = $renewal_id;") or die(mysqli_error($con));
