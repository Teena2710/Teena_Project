...
// $res=mysqli_query($con,"select * from tbl_duplicatelicense where dup_id=$dup_id");
// $row=mysqli_fetch_array($res);
    $lid=$_SESSION['user'];

$a=mysqli_query($con,"select * from tbl_drivinglicense where reg_id='$lid'");
...
if(isset($_POST['img_update']))
{
    ...
    $sql= mysqli_query($con,"UPDATE tbl_duplicatelicense SET `image`='$iname' where `driving_id`='$b'")
...
if(isset($_POST['update']))
{
    ...
    $ql= mysqli_query($con,"UPDATE tbl_duplicatelicense SET `aadhar`='$aname' where driving_id='$b'")
     or die(mysqli_error($con));
...
if(isset($_POST['sslc_update']))
{
    ...
    $sql= mysqli_query($con,"UPDATE tbl_duplicatelicense SET `sslc`='$sname' where driving_id='$b'")
    or die(mysqli_error($con));
    if($sql)
    {
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <button  class="nav-item nav-link active"><a href="duplicate_app.php">Home</a></button>
        ...
        <embed src="img/<?php echo $row['image']?>" width=200 height=300 />
