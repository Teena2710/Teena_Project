...
if(isset($_SESSION['own_id']))
{
  ...
  $oid= $_SESSION['own_id'];
  $sql=mysqli_query($con,"select * from tbl_ownership where owner_id=$oid") or die(mysqli_error($con));
...
if(isset($_POST['submit'])){
  ...
  $to      = $user;
  $subject = 'Appointment Details - Ownership Transfer';
  $message = 'Your application no for ownership transfer:  '.$applno."\n".'Reporting Date: '.$date."\n".' Reporting Time: '.$time;
  ...
  if($result)
  {
    ...
    echo "<script>alert('Mail Send Successfully');window.location.href='ownershipappointment.php';</script>";     
  }
  else
  {
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>RTO  - Ownership Transfer</title>
...
<!-- <div class="center">
      <h1>Ownership Transfer Appointment</h1>
      ...
      <div class="cont">
    <div class="title"><b>Ownership Transfer Appointment<b></div>
    <br/> <br/> <br/>
    <div>
    ...
    cursor: pointer;
    outline: none;"><br><br>
    <A href="rto_ownership.php"><input type="submit" name="submit"  value="Back" style="width: 82%;
    margin-left: 35px;
    height: 50px;
    border: 1px solid;
    background: #2691d9;
