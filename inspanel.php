                        ...
                        <div class="navbar-nav mr-auto">
                           ...
                           <!-- <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="ins_list.php" class="dropdown-item">Instructor List</a>
                                   
        
                                </div>
                            </div> -->
                            <a href="Traffic.html" class="nav-item nav-link">Traffic signs</a>
                            <a href="videos.html" class="nav-item nav-link">Road Safety Videos</a>
                            <!-- <a href="ins_list.php" class="nav-item nav-link">Instructor List</a> -->
                            <a href="ins_vehicle_reg.php" class="nav-item nav-link">Vehicle Register</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Approval</a>
                                <div class="dropdown-menu">
                                    <a href="ins_list.php" class="dropdown-item">Instructor List</a>
                                    <a href="user_list.php" class="dropdown-item">User List</a>
                                    <a href="leave_approval.php" class="dropdown-item">Leave Approval</a>
        
                                </div>
                            </div>
                            <!-- <a href="approval.php" class="nav-item nav-link">Approval</a>
                            <a href=".php" class="nav-item nav-link">Register</a> -->
                            <a href="fees.html" class="nav-item nav-link">Fees & user charges</a>
                            <a href="forgot_password.php" class="nav-item nav-link">Change Password</a>
