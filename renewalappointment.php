...
// $chk=$_SESSION['check'];
$date=date('Y-m-d');
if(isset($_SESSION['renew_id']))
{
 
  $reid= $_SESSION['renew_id'];
  $sql=mysqli_query($con,"select * from tbl_renewal where renewal_id=$reid") or die(mysqli_error($con));
...
if(isset($_POST['submit'])){
  ...
  $to      = $user;
  $subject = 'Appointment Details - Renewal License';
  $message = 'Your application no for renewal license:  '.$applno."\n".'Reporting Date: '.$date."\n".' Reporting Time: '.$time;
  ...
  if($result)
  {
    ...
    echo "<script>alert('Mail Send Successfully');window.location.href='renewalappointment.php';</script>";     
  }
  else
  {
...
<!-- <div class="center">
      <h1>Renewal License Appointment</h1>
   
      <form action="" method="post" >
      <div class="txt_field">
        <input type="text"   value="<?php //echo $row['reg_id'];?>" name="applno" id="applno" > 
	      <span></span>
      ...
      <div class="txt_field">
       ...
       <div class="cont">
    <div class="title"><b>Renewal License Appointment<b></div>
    <br/> <br/> <br/>
    <div>
