...
if(isset($_POST['register']))
{
  ...
  $sql=mysqli_query($con,"INSERT INTO `tbl_renewal` (`reg_id`, `first_name`, `last_name`, `age`, `gender`, `parent_name`,`house_name`,`state`,`district`, `email`, `phone_no`, `license_type`, `date_of_issue`, `expiriry_date`, `blood`,`image`,`identity_proof`,`dob_proof`,`driving_license`,`is_approved`,`paystatus`) VALUES ('$regid', '$fname', '$lname', '$age', '$gender','$pname', '$house_name', '$state','$district', '$email', '$phone', '$ltype', '$isdate', '$exdate', '$blood','$iname','$cname','$sname','$dname','NO','Unpaid')") or die(mysqli_error($con));
  if($sql)
...
//       window.history.forward();
 // }
   ...
   <!-- <script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_JlcF3oWOYU3VN8" async> </script> </form> -->
   <form action="renewal_payaction.php?id=<?php echo $regid;?>" method="post" style="margin-top:50px;" align="center">
<script
