...
if(isset($_POST['submit']))
{
  ...
  mysqli_query($con,"insert into tbl_register(fname,lname,gender,email,house_name,state,district, phone_no,username,password,repassword)values
  ('$fname','$lname','$gender','$email','$house_name', '$state','$district','$phone','$username',md5('$pass'),md5('$pass'))");
$last_id=mysqli_insert_id($con);
mysqli_query($con,"insert into tbl_login values($last_id, '$username',md5('$pass'),'instructor','4')") or die(mysqli_error($con));
...
<head>
    <meta charset="utf-8">
    <title>RTO - Instructor Registeration</title>
...
<div class="user_reg">
    <div class="title"><b>Instructor Registration<b></div>
    <br/> <br/> <br/>
    <div>
    ...
    <form  method="post" enctype="multipart/form-data"  action="#" onsubmit="return validation(this);">
        <div class="user-details">
          ...
          <select style="height:45px;width:430px;">
...
var pas2=document.getElementById("repass");
	...
	return true;
                ...
                <input type="submit" name="submit"  value="Register" style="width: 80%;
    margin-left: 35px;
    height: 50px;
    border: 1px solid;
    background: #2691d9;
    ...
    cursor: pointer;
    outline: none;">     
      <div style="text-align:center;">   Already have a account?<a href="login.php" style=" color: blue;">Login</a></div>
                    </form>
            </div>
