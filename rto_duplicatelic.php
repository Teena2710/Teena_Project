...
$sql=mysqli_query($con,"SELECT * FROM `tbl_duplicatelicense` where is_approved='YES' order by dup_id ASC") or die(mysqli_error($con));
if(isset($_POST['approve']))
{
    $dup_id=$_POST['dup_id'];
    mysqli_query($con,"UPDATE `tbl_duplicatelicense` SET `is_approved` = 'APPROVED' WHERE `tbl_duplicatelicense`.`dup_id` = $dup_id;") or die(mysqli_error($con));
    $_SESSION['dupid']= $dup_id;
    header('location:duplicateappointment.php');
}
