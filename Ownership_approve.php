...
$sql=mysqli_query($con,"SELECT * FROM `tbl_ownership` where is_approved='GENERATED' order by owner_id ASC") or die(mysqli_error($con));
...
<html lang="en">
    ...
    <body>
        ...
        <!-- Nav Bar End -->
    <h1 align="center">Vehicle Ownership Transfer Approved List</h1>
    <div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>Application ID</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Dealer Name</b></td><td><b>Dealer Address</b></td><td><b>Recipient Name</b></td><td><b>Recipient Address</b></td><td></td></tr>
