...
$result=mysqli_query($con,"SELECT first_name,last_name,age,gender,parent_name,house_name,state,district,email,phone_no,license_type,date_of_issue,expiriry_date,blood,paystatus,pay_date FROM `tbl_renewal` where renewal_id=$renewal_id") or die(mysqli_error($con));
