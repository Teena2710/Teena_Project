...
$regid=$_SESSION['user'];
$sql=mysqli_query($con,"select * from tbl_drivinglicense where reg_id=$regid") or die(mysqli_error($con));
...
if(isset($_POST['verifyemail']))
{
  ...
  if($count>0)
  {
    ...
    if($result)
    {
      ...
      echo "<script>alert('Mail Send Successfully');window.location.href='duplicatelicense_2.php';</script>";     
    }
    else
    {
