...
if(isset($_POST['register']))
{
  ...
  move_uploaded_file($_FILES['pollution']['tmp_name'],$pathinfo1);
    ...
    $sql=mysqli_query($con,"INSERT INTO `tbl_ownership` (`reg_id`, `first_name`, `last_name`, `age`,`house_name`, `state`,`district`, `email`, `phone_no`, `dealer_name`, `dealer_address`, `recipient_fname`,  `recipient_lname`,`recipient_house_name`,`recipient_state`,`recipient_district`,`vehicle_number`,`vehicle_name`,`vehicle_type`,`fuel`,`weight`,`seating_capacity`,`aadhar`,`sslc`,`pollution`,`is_approved`) VALUES ('$regid', '$fname', '$lname', '$age', '$house_name', '$state','$district','$email', '$phone', '$dname','$daddress','$rname','$rlname','$recipient_house_name','$recipient_state','$recipient_district','$vnumber','$vname','$vtype','$fuel','$weight','$scapacity','$aname','$sname','$pname','NO')") or die(mysqli_error($con));
    if($sql)
...
//       window.history.forward();
 // }
    ...
    <body>
        ...
        <!-- Nav Bar End -->
<!-- <form align="center" style="margin-top:50px;"><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_JlcF3oWOYU3VN8" async> </script> </form> -->
    <form action="ownership_payaction.php?id=<?php echo $regid;?>" method="post" style="margin-top:50px;" align="center">
<script
    ...
    data-name="RTO-Ownership Transfer"
