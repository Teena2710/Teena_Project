...
$sql=mysqli_query($con,"SELECT * FROM `tbl_drivinglicense` where is_approved='APPROVED' order by driving_id ASC") or die(mysqli_error($con));
if(isset($_POST['generate']))
{
    $driving_id=$_POST['driving_id'];
    mysqli_query($con,"UPDATE `tbl_drivinglicense` SET `is_approved` = 'GENERATED' WHERE `tbl_drivinglicense`.`driving_id` = $driving_id;") or die(mysqli_error($con));
    $_SESSION['driving_id']=$driving_id;
    header('location:drivinglic_certi.php');
}
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>RTO  - Generate Driving License</title>
  ...
  <center>
    ...
    <div class="title"><b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Generate Driving License<b></div>
    <br/><br/>
    <div>
    <?php 
