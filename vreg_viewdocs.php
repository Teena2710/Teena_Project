...
$res=mysqli_query($con,"select * from tbl_vreg where vreg_id=$vreg_id");
...
<html lang="en">
    ...
    <body>
        ...
        <img width=500 height=500 src='uploads/<?php echo $row['proof']?>'><br>
        <h3>SSLC</h3>
        <img width=500 height=500 src='uploads/<?php echo $row['sslc']?>'><br>
        <h3>Aadhar</h3>
        <img width=500 height=500 src='uploads/<?php echo $row['aadhar']?>'><br>
        <h3>Vehicle Image</h3>
        <img width=500 height=500 src='uploads/<?php echo $row['vimage']?>'><br>
