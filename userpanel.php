                        ...
                        <div class="navbar-nav mr-auto">
                           ...
                           <!--<a href="service.html" class="nav-item nav-link">Service</a>--> 
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                <a href="driving_app.php" class="dropdown-item">Driving License</a>
                                <a href="duplicate_app.php" class="dropdown-item">Duplicate License</a>
                                    <a href="learners_app.php" class="dropdown-item">Learners License</a>
                                    <a href="ownership_app.php" class="dropdown-item">Ownership Transfer</a>
                                    <a href="renewal_app.php" class="dropdown-item">Renewal License</a>
                                    <a href="vehicle_app.php" class="dropdown-item">Vehicle Registration</a>
