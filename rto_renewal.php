...
$sql=mysqli_query($con,"SELECT * FROM `tbl_renewal` where is_approved='YES' order by renewal_id ASC") or die(mysqli_error($con));
if(isset($_POST['approve']))
{
    $renewal_id=$_POST['renewal_id'];
    mysqli_query($con,"UPDATE `tbl_renewal` SET `is_approved` = 'APPROVED' WHERE `tbl_renewal`.`renewal_id` = $renewal_id;") or die(mysqli_error($con));
    // echo "<script>alert('Approved successfully');window.location.href='suboffrenewal.php';</script>";
    $_SESSION['renew_id']=$renewal_id;
    header('location:renewalappointment.php');
}
if(isset($_POST['reject']))
{
    $renewal_id=$_POST['renewal_id'];
    $_SESSION['renewal_id']=$renewal_id;
    header('location:suboffrenewal_rejectReason.php');
}
if(isset($_POST['viewdetails']))
{
    ...
    $renewal_id=$_POST['renewal_id'];
    $_SESSION['renewal_id']=$renewal_id;
    header('location:suboffrenewal_pdfviewdetails.php');
}
if(isset($_POST['viewdocs']))
{
    $renewal_id=$_POST['renewal_id'];
    $_SESSION['renewal_id']=$renewal_id;
    header('location:viewdocs_renewal.php');
}
?>
...
<html lang="en">
    ...
    <body>
        ...
        <!-- Nav Bar End -->
    <h1 align="center">Renewal License List</h1>
                    ...
                    <tr>
                       ...
                       <!-- <td><?php //echo $res['blood'];?></td>-->
                        ...
                        <td><form action="" method="post">
                            <input type="hidden" name="renewal_id" value="<?php echo $res['renewal_id'];?>">
