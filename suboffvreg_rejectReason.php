...
$sql=mysqli_query($con,"SELECT * FROM `tbl_vreg` where vreg_id=$vreg_id") or die(mysqli_error($con));
...
if(isset($_POST['submit']))
{
    ...
    $result=mail($to, $subject, $message, $headers);
        if($result)
		{
            ...
            echo "<script>alert('Response send Successfully');window.location.href='suboffvreg.php';</script>";

			
		}
        else
		{
			echo "<script>alert('Something went wrong...');window.location.href='suboffvreg.php';</script>";
		}
