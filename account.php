...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td><td>Unattended</td>
...
<center><p><b>Time Left: <font color=red><span id="countdown" class="timer"></span></font></b></p></center>
<script>
var seconds = 90;
    ...
    if (seconds == 0) {
       ...
       window.location.href="userdash.php?q=timeexp";
    } else {    
        seconds--;
    }
    }
...
echo '<tr style="color:#66CCFF"><td>Total Questions</td><td>'.$qa.'</td></tr>
    ...
    <tr style="color:##99cc32"><td>Status&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$passstatus.'</td></tr>';
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Email</b></td><td><b>Score</b></td><td><b>Date</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$s.'</td><td>'.$date.'</td><td>';
}
echo '</table></div></div>';}
?>
