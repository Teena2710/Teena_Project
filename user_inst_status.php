...
$sql=mysqli_query($con,"SELECT * FROM `tbl_user_inst_reg` where (is_approved='APPROVED' OR is_approved='REJECTED' OR is_approved='NO') and regid='$reg'  order by user_inst_id ASC") or die(mysqli_error($con));
if(isset($_POST['institution']))
{
    $user_inst_id=$_POST['user_inst_id'];
    $_SESSION['user_inst_id']=$user_inst_id;
    header('location:user_inst_panel.php');
}
?>
...
<tr><td style="width:300px;background:white;"><b>Applicant Name</b></td><td style="width:200px;"><b>Status</b></td></tr>    
...
<td width=300><form method="post">
                            <input type="hidden" name="user_inst_id" value="<?php echo $res['user_inst_id'];?>">
                            <button type="submit" name="institution" style="width: 190%;
    margin-left: 35px;
    height: 50px;
    border: 1px solid;
    text-align:center;
    ...
    font-weight: 700;
    cursor: pointer;
    outline: none;">Enter Institution</button>
        </table>
    </body>
</html>
