...
if(!(isset($_SESSION['email']))){
  ...
  // include_once 'dbConnection.php';
  // echo '<span class="pull-right top title1" ><span class="log1">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="userdash.php?q=0">Home<span class="sr-only">(current)</span></a></li>
        
        <li><a href="userpanel.php">Signout</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td><b>Status</b></td><td></td></tr>';
$c=1;
...
{
  $q12res=mysqli_fetch_array($q12);
  $scorevalue=$q12res['score'];
  if($scorevalue>=15){
    $passstatus='<b>Passed</b>';
  }  
  else{
    $passstatus='<font color=red><b>Failed</b></font>';
  }
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td><td>'.$passstatus;
//echo	'<td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div></div>';
...
while($row = mysqli_fetch_array($result)) {
	...
	$id = $row['id'];
	 echo '<tr><td>'.$c++.'</td>';
	echo '<td><a title="Click to open feedback" href="userdash.php?q=3&fid='.$id.'">'.$subject.'</a></td><td>'.$email.'</td><td>'.$date.'</td><td>'.$time.'</td><td>'.$name.'</td>
	<td><a title="Open Feedback" href="userdash.php?q=3&fid='.$id.'"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
...
sleep(3);
echo "<script>window.location.href='userdash.php?q=0';alert('Time Expired');</script>";
//header('location:');
}
?>
