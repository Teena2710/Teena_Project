...
$regid= $_SESSION['user'];
$sql=mysqli_query($con,"SELECT `regid`,`fname`, `lname`, `is_approved` FROM tbl_user_inst_reg where `regid`=$regid and `is_approved`='APPROVED'")or die(mysqli_error($con));
$check=mysqli_num_rows($sql);
if($check==0){
    echo "<script>alert('You dont have the permission ');window.location.href='userpanel.php';</script>";
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="traffic.php" class="nav-item nav-link">Traffic signs</a>
                            <a href="videos.php" class="nav-item nav-link">Road Safety Videos</a>
