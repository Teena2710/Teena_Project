...
$sql=mysqli_query($con,"SELECT * FROM `tbl_vreg` where is_approved='APPROVED' order by vreg_id ASC") or die(mysqli_error($con));
if(isset($_POST['generate']))
{
    $vreg_id=$_POST['vreg_id'];
    mysqli_query($con,"UPDATE `tbl_vreg` SET `is_approved` = 'GENERATED' WHERE `tbl_vreg`.`vreg_id` = $vreg_id;") or die(mysqli_error($con));
    $_SESSION['vreg_id']=$vreg_id;
    header('location:vreg_certi.php');
}
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>RTO  - Generate Vehicle Registration</title>
  ...
  <center>
    ...
    <div class="title" align="center"><b>&emsp;&emsp;&emsp;&emsp;Generate Vehicle Registration<b></div>
    <br/><br/>
    <div>
    <?php 
  ...
  <form action="" method="post" >
      <div >
        <div class="user-details">
          <br>
        <div class="input-box">
            <span class="details" id="message1">Enter Vehicle ID</span>
            <input type="number"  value="<?php echo $res['vreg_id']; ?>">
