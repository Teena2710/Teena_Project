...
$result=mysqli_query($con,"SELECT first_name,last_name,age,gender,parent_name, `house_name`, `state`,`district`,email,phone_no,license_type,date_of_issue,expiriy_date,blood,paystatus,pay_date FROM `tbl_duplicatelicense` where dup_id=$dup_id") or die(mysqli_error($con));
