...
if(isset($_POST['register']))
{
  ...
  $sql=mysqli_query($con,"INSERT INTO `tbl_duplicatelicense` (`driving_id`, `first_name`, `last_name`, `age`, `gender`, `parent_name`, `house_name`, `state`,`district`,  `email`, `phone_no`, `license_type`, `date_of_issue`, `expiriy_date`, `blood`,`image`,`aadhar`,`sslc`,`is_approved`) VALUES ('$driving_id', '$fname', '$lname', '$age', '$gender','$pname','$house_name', '$state','$district','$email', '$phone', '$ltype', '$isdate', '$exdate', '$blood','$iname','$aname','$sname','NO')") or die(mysqli_error($con));
  if($sql)
...
//       window.history.forward();
 // }
    ...
    <body>
        ...
        <!-- Nav Bar End -->
<!-- <form align="center" style="margin-top:50px;"><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_JldIubBztdrYMC" async> </script> </form> -->
    <form action="duplicate_payaction.php?id=<?php echo $regid;?>" method="post" style="margin-top:50px;" align="center">
<script
    ...
    data-name="RTO - Duplicate License"
