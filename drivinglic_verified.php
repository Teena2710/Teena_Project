...
if(isset($_POST['register']))
{
  ...
  $sql=mysqli_query($con,"INSERT INTO `tbl_drivinglicense` (`reg_id`, `first_name`, `last_name`, `age`, `gender`, `parent_name`, `house_name`, `state`,`district`, `email`, `phone_no`, `license_type`, `date_of_issue`, `expiriry_date`, `blood`,`image`,`aadhar`,`sslc`,`is_approved`,`paystatus`) VALUES 
  ('$regid', '$fname', '$lname', '$age', '$gender','$pname', '$house_name', '$state','$district', '$email', '$phone', '$license_type', '$isdate', '$exdate', '$blood','$iname','$aname','$sname','NO','Unpaid')") or die(mysqli_error($con));
  if($sql)
...
if(isset($_POST['emailverify']))
{
  ...
  header('location:drivinglic_otp.php');
}
if(isset($_POST['back']))
{

  header('location:drivinglic_2.php');
}
?>
<!DOCTYPE html>
...
$('#exdate').datepicker("option","minDate",selectedDate);
  ...
  <div class="duplicate">
    <div class="title"><b>Driving License Registration<b></div>
    <br/> <br/> <br/>
    <div>
       
    <form action="driving_pay.php" method="post" enctype="multipart/form-data">
      ...
      function ValidEmail() 
          ...
          <div class="input-box">
            ...
            <input type="text" name="ph" id="ph" required autofocus autocomplete = "off" required onchange="ValidPhone();">
          ...
          <option value="AB-">AB-</option>
            ...
            <!-- <input type="text" name="blood"  id="blood" onkeyup="blood();" value="">  
            <span id='msg9'></span>  -->
          </div>
          <div class="input-box">
