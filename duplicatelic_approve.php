...
$sql=mysqli_query($con,"SELECT * FROM `tbl_duplicatelicense` where is_approved='GENERATED' ") or die(mysqli_error($con));
...
<html lang="en">
    ...
    <body>
        ...
        <h1 align="center">Duplicate License  Approved List</h1>
    <div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>Driving ID</b></td><td><b>Image</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>License Type</b></td><td><b>Date of Issue</b></td><td><b>Expiriry Date</b></td><td></td></tr>
